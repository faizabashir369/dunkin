...
?>
                ...
                <div id="orders" class="summary">
                    ...
                    <div class="row bor active_orders">
                        ...
                        else
                        {
                            ...
                            ?>
                        <button class="full_width pink-clr" id="dunkin-pay" onclick="createorder(this.id)">DUNKIN Pay</button>
                    <?php } ?>
                    <br><br><br>

                        <button class="full_width pink-clr" id="card-pay" onclick="createorder(this.id)">
                            <?php 
                            if($lang=='ar'){
                              echo 'ادفع الان';
                            }
    ...
    /*    if (cart==null || cart.length == 0) {
            ...
            for (var i=0; i<cart.length;i++) {
                ...
                var product_prices=product_price*quantity;
             //   var  milk=items.milk_option;
                total_price=(parseInt(total_price,10))+(parseInt(product_prices,10));
...
if(new_array[0]=="S" || new_array[0]=="M" || new_array[0]=="L" || new_array[0]=="XL" || new_array[0]=="S " || new_array[0]=="M " || new_array[0]=="L " || new_array[0]=="XL ")
                   {
                ...
                */
                    ...
                    row +=   '</div>';
                      ...
                      row +=   '</div>';
                      row +=   '<div class="col s2 m2 l2 no-padding">';
                      row +=    '<p class="item-price">SR '+parseFloat(product_price*quantity).toFixed(1);+'</p>';
                      row +=   '</div>';
                      row  +='</div>';
    ...
    return str.split(' ').reduce(function(prev, curr, i){
        ...
        function createorder(btn_id)
        {
            
            if(btn_id=="dunkin-pay")
            {
                payment_type="dunkin_pay";
                localStorage.setItem("payment_type",payment_type);
            }
            else if(btn_id=="card-pay")
            {
         ...
         */   
          ...
          //  alert(total_price);
            ...
            if($.cookie("device_id")==undefined || $.cookie("device_id")==null)
                            {
                                    cust_device_id='jdfhjsdhfhsj';
                            }
            ...
            //  alert(total_price);
            var total_price=document.getElementById("total_amount").value;
            if(document.getElementById("discount_amount").value==undefined || document.getElementById("discount_amount").value==null || document.getElementById("discount_amount").value=="")
           {
                document.getElementById("discount_amount").value="0";
           }
           // alert(total_price);
           ...
           data=JSON.stringify({products:products,pickup_time:date,discount_code:discount_code,discount_type:discount_type,discount_amount:d_amt,cust_name:name,cust_mob_no:phone,cust_email:email,cust_device_id:cust_device_id,cust_device_type:cust_device_type,branch_id:branch_id,total_price:total_price});
            ...
            var total_pp=document.getElementById('net_price').value;
            if(giftCard==1)
            {
                        ...
                        var cart=localStorage.getItem("cart");
                          ...
                          if(payment_type=="credit_card")
                          {
                                        ...
                                        else
                                        {
                                            ...
                                            $.ajax({
                                            type: 'POST',
                                            url: 'dunkin_pay.php?amount='+total_pp,
                                            cache: false,
                                            contentType:false,
                                            processData: false,
                                            data : cart,
                                        ...
                                        for (var i in products) {
                                         ...
                                         var products = JSON.parse(localStorage.getItem("cart"));
                                            ...
                                            $.ajax({
                                            type: 'POST',
                                            url: 'createGiftCards.php?payment_type='+payment_type,
                                            cache: false,
                                            contentType:false,
                                            processData: false,
                                            data: json_data,
                        ...
                        Swal.fire({
                                      ...
                                      confirmButtonText:ok,
                                            ...
                                            `
                                                ...
                                                localStorage.removeItem("discount_code");
                                                localStorage.removeItem("discount_type");
                                                document.getElementById("discount_code").value='0';
                               ...
                               //alert("json"+json_data);
                                var cart = JSON.parse(localStorage.getItem("cart"));
                                    ...
                                    products2.push({
                                        ...
                                        quantity: items.quantity, 
                                        product_category: items.product_category, 
                                        product_price: items.product_price*items.quantity, 
                                        product_name: items.product_name, 
                                        product_variant_id: items.product_variant_id,
                                        note: items.note
                                   });
                                        ...
                                        else
                                        {
                                            ...
                                            { 
                                                ...
                                                if(response.code=='200')
                                                {
                                                    ...
                                                    var loyality_card_number="<?php echo $_SESSION['loyality_card_number'];?>";
                            $.ajax({
                                type: 'POST',
                                url: 'createOrderShopify.php?payment_type='+payment_type+'&loyality_card_number='+loyality_card_number,
                                cache: false,
                                contentType:false,
                                processData: false,
                                data: json_data,
                              ...
                              //  $("#loaderIcon").show();
                                ...
                                { 
                                 ...
                                 //  alert(response);
                                    ...
                                    var message="<?php if($lang=='ar')

        { echo 'تم قبول طلبك ويمكنك معرفة رقم الشحنة من خلال صفحة الطلبات السابقة';}
                    ...
                    $.ajax({
                    type: 'POST',
                    url: 'create_order.php?payment_type='+payment_type+'&loyality_card_number='+loyality_card_number,
                    cache: false,
                    contentType:false,
                    processData: false,
                    data: data,
                                            ...
                                            { 
                                               ...
                                               console.log(response.code);
                                                if(response.code=='200')
                                                {
                                                    ...
                                                    $.ajax({
                                    type: 'POST',
                                    url: 'form_submit.php?order_id='+order_id+'&branch_id='+branch_id+'&order_status='+'Pending&transaction_id=0',
