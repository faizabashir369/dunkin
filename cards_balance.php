 ...
 //set it to writable location, a place for temp generated PNG files
    ...
    $matrixPointSize = 10;
                        ...
                        curl_setopt_array($curl, array(
                          ...
                          CURLOPT_POSTFIELDS => array('shopify_customer_id' => $customer_id),
                ...
                <div class="third-menu">
                    <a class="tablinks active" href="#" onclick="openTab(event, 'mycards')"><?php if($lang=='ar'){ echo "بطاقات دنكنها ";}  
                                else
                    ...
                    <div id="addcards" class="tabcontent">
                    <div class="row">
